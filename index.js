...
console.log('taks 1e', finals2014[0]['Win conditions']);
...
function getFinals(array) {
   ...
   let filteredArray = array.filter(item => item.Stage === 'Final');
...
function getWinners(array, getFinalsCB) {
    const winners = getFinalsCB(array).map(item => {
        ...
        return item['Home Team Name']} else {
...
function getAverageGoals(getFinalsCB) {
   const averageG = getFinalsCB.reduce((acc,item) => acc + item['Home Team Goals'] + item['Away Team Goals'], 0);
